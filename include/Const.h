...
const sf::Vector2i QUIT_POS = sf::Vector2i(SCREEN_W / 2 - 65, SCREEN_H + -325),
			INFO_POS = sf::Vector2i(SCREEN_W / 2 - 130, SCREEN_H + -410),
			START_POS = sf::Vector2i(SCREEN_W / 2 - 72, SCREEN_H + -495),
			TITLE_POS = sf::Vector2i(400, 55);
